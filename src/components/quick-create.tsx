        ...
        {created ? <div className="success-state"><span>✓</span><h3>Guardado</h3><p>El elemento ya está disponible para tu equipo.</p></div> : (
          <form onSubmit={submit}>
            ...
            {kind === "project" ? <>
              ...
              <label className="field-label">Visibilidad<select value={visibility} onChange={(event) => setVisibility(event.target.value as typeof visibility)}><option value="private">Privado · solo yo y colaboradores</option><option value="shared">Compartido · personas invitadas</option><option value="workspace">Grupo · visible para todo el equipo</option></select></label>
