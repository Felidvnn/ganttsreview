        ...
        {created ? <div className="success-state"><span>✓</span><h3>Guardado</h3><p>El elemento ya está disponible para tu equipo.</p></div> : (
          <form onSubmit={submit}>
            ...
            {kind === "project" ? <>
              ...
              <label className="field-label">Visibilidad<select value={visibility} onChange={(event) => setVisibility(event.target.value as typeof visibility)}><option value="private">Privado · solo tú</option><option value="shared">Con mi líder · puede verlo y hacer seguimiento</option><option value="workspace">Colaborativo · personas invitadas (líder opcional en Acceso)</option></select></label>
